...
namespace ShortAir
{
    public class KeyCongfig
    {
        ...
        public static Dictionary<string, object> actions = new Dictionary<string, object>()
        {
            ...
            {"y", 'y'},
            {"z", 'z'},
            {"0", VirtualKey.NumberPad0 },
            {"1", VirtualKey.NumberPad1 },
            {"2", VirtualKey.NumberPad2 },
            {"3", VirtualKey.NumberPad3 },
            {"4", VirtualKey.NumberPad4 },
            {"5", VirtualKey.NumberPad5 },
            {"6", VirtualKey.NumberPad6 },
            {"7", VirtualKey.NumberPad7 },
            {"8", VirtualKey.NumberPad8 },
            {"9", VirtualKey.NumberPad9 },
            {"[", '['},
            {"]", ']'},
            {"SPACE",' '},
